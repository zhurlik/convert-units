...
[![Build Status](https://travis-ci.org/bstoots/convert-units.png)](https://travis-ci.org/bstoots/convert-units)
...
Adding new measurement sets is easy. Take a look at [`lib/definitions`](https://github.com/bstoots/convert-units/tree/master/lib/definitions) to see how it's done.
